...
import de.melanx.utilitix.content.ItemDiamondShears;
import de.melanx.utilitix.content.ItemTinyCoal;
...
import de.melanx.utilitix.content.redstone.wireless.ItemLinkedCrystal;
...
public class ModItems {
    ...
    public static final Item tinyCoal = new ItemTinyCoal(UtilitiX.getInstance(), new Item.Properties(), 200);
    public static final Item tinyCharcoal = new ItemTinyCoal(UtilitiX.getInstance(), new Item.Properties(), 200);
    ...
    public static final Item diamondShears = new ItemDiamondShears(new Item.Properties().stacksTo(1).durability(1486).component(DataComponents.TOOL, ShearsItem.createToolProperties()));
