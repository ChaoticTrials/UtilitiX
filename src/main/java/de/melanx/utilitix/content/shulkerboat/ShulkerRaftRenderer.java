...
public class ShulkerRaftRenderer extends RaftRenderer {
    ...
    public ShulkerRaftRenderer(EntityRendererProvider.Context context, ModelLayerLocation modelId) {
    ...
    protected void submitTypeAdditions(@Nonnull BoatRenderState state, @Nonnull PoseStack poseStack, @Nonnull SubmitNodeCollector submitNodeCollector, int lightCoords) {
        ...
        poseStack.pushPose();
        poseStack.translate(-0.46, -1.33, 0);
