...
public class ContainerMenuAdvancedBrewery extends BlockEntityMenu<TileAdvancedBrewery> {
    ...
    public ContainerMenuAdvancedBrewery(@Nullable MenuType<? extends BlockEntityMenu<?>> type, int windowId, Level level, BlockPos pos, Inventory playerContainer, Player player) {
